  ...
  function resize(){
    ...
    if(document.body.offsetWidth > 825)
    {
      ...
      if(document.readyState=="complete"){
        fnbar.children[0].children[2].children[0].innerHTML = (usr.usrid != ""&&typeof usr.usrid!="undefined") ? "Account" : "Sign In";
        fnbar.children[0].children[2].children[0].href = "?account";
        fnbar.children[0].children[2].children[0].setAttribute('tips',(usr.usrid != ""&&typeof usr.usrid!="undefined") ? "Account" : "Sign In");
        fnbar.children[0].children[3].children[0].innerHTML = (usr.usrid == ""||typeof usr.usrid=="undefined") ? "Sign Up" : "Sign Out";
        fnbar.children[0].children[3].children[0].href = (usr.usrid == ""||typeof usr.usrid=="undefined") ? "?account#signup" : "javascript:signout();";
        fnbar.children[0].children[3].children[0].setAttribute('tips',(usr.usrid == ""||typeof usr.usrid=="undefined") ? "Sign Up" : "Sign out");
      }
    }else{
      fnbar = vy.children[0].children[2];
      if(document.readyState=="complete"){
        fnbar.children[0].children[2].children[0].innerHTML = "Account";
        fnbar.children[0].children[2].children[0].href = "?account";
        fnbar.children[0].children[2].children[0].setAttribute('tips', "Account");
        fnbar.children[0].children[3].children[0].innerHTML = (usr.usrid == ""||typeof usr.usrid=="undefined") ? "Sign Up" : "Sign Out";
        ...
        if(window.location.pathname.indexOf("?account")>=0&&!(usr.usrid == ""||typeof usr.usrid=="undefined")){
          fnbar.children[0].children[2].children[0].innerHTML = "Sign Out";
          fnbar.children[0].children[2].children[0].href = "javascript:signout();";
          fnbar.children[0].children[2].children[0].setAttribute('tips',"Sign Out");
        }
      }
    }
